<form action="<?= base_url($form_action) ?>" method="POST" id="form-builder-question" class="card">
	<div class="card-body">
		<div class="row">
			...
			<div class="col-4">
				<div class="form-group">
					<select name="answer_type_id" id="answer-type" class="form-control">
	...
	<div class="card-footer d-flex justify-content-between">
		...
		<div>
			<!-- <button type="button" class="btn btn-primary btn-save-question">Save</button> -->
		...
		<!-- <a href="<?= base_url('ajax/modal-question-library/'.$form_id) ?>" class="btn btn-sm btn-success modal-link" data-question-id="<?= $form_id ?>">Question Library</a> -->
		<?php endif; ?>
