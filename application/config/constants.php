...
defined('API_BASE_URL')        OR define('API_BASE_URL', 'http://localhost/aws_staging/aws.api/public/');
defined('API_BASE_URLS')        OR define('API_BASE_URLS', 'http://localhost/aws_staging/aws.api/public/'); // no errors
